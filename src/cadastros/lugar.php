        ...
        <form method="post" class="form">
            <div class="form-group">
                ...
                <input type="text" name="nome" id="nome" required class="form-control"
                    value="<?= htmlspecialchars($editing ? $lugar['nome'] : ($nome ?? '')) ?>">
            </div>

            <div class="form-group">
                <label for="descricao" class="form-label">Descrição:</label>
                <textarea name="descricao" id="descricao" class="form-control"><?= htmlspecialchars($editing ? ($lugar['descricao'] ?? '') : ($descricao ?? '')) ?></textarea>
            </div>
