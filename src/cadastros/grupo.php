    ...
    if (empty($errors)) {
        try {
            if ($editing) {
                ...
                $check = $pdo->prepare("SELECT id FROM grupos WHERE nome = :nome");
...
<head>
    ...
    <title><?= $editing ? 'Editar' : 'Cadastro de' ?> Grupo de Produtos</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1><?= $editing ? 'Editar' : 'Cadastro de' ?> Grupo de Produtos</h1>
        ...
        <form method="post">
            <div class="form-group">
                <label for="nome">Nome do Grupo: <span style="color: red;">*</span></label>
            ...
            <div class="form-group">
                ...
                <textarea name="descricao" id="descricao"><?= $editing ? htmlspecialchars($grupo['descricao'] ?? '') : (isset($descricao) ? htmlspecialchars($descricao) : '') ?></textarea>
            </div>
        ...
        <div>
            <?php if ($editing): ?>
                <a href="list_grupos.php" class="btn">Cancelar</a>
            <?php else: ?>
                <a href="../index.php" class="btn">Voltar para a Página Inicial</a>
                <a href="list_grupos.php" class="btn-link">Ver Lista de Grupos</a>
            <?php endif; ?>
        </div>
    </div>
</body>
