...
5. O sistema já está configurado com uma chave SSH (aws@gmedeiros.net) para acesso à instância EC2. Se necessário, você pode modificar ou adicionar chaves SSH no arquivo `main.tf`
